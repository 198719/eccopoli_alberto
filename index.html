...
<head>
    ...
    <meta name="Eccopoli-website" content="Eccopoli">
    <meta name="author" content="Alberto Martínez Mendoza">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="css/style.css">
    <link rel="stylesheet" href="css/fonts.css">
    <script src="js/jquery-1.10.2.min.js"></script>
    <script src="js/JSParallax.js"></script>
...
<body> 
    ...
    <section id="colaboradores">
       ...
       <div class="colaborador">
            <img class="rafael" src="image/rafael.jpg" alt="Foto de Rafael coordinador del proyecto">
            <h3>Project Coordinator</h3>
            <p class="prafael">Rafael RODRIGUEZ-LEAL T.</p>
        </div>

        <div class="colaborador">
            <img class="pierre" src="image/Pierre_Antoine.jpg" alt="Foto de Rafael coordinador del proyecto">
            <h3>Legal Adviser and Rule of Law Specialist</h3>
            <p class="ppierre">Pierre Antoine BLAISE </p>
        </div>

        <div class="colaborador">
            <img class="jesula" src="image/Jesula-BLANC.jpg" alt="Foto de Jesula-BLANC, especialista en Equidad">
            <h3>Gender Equality Specialist and Executive Secretary</h3>
            <p class="pjesula">Jesula BLANC</p>
        </div>

        <div class="colaborador">
            <img class="travis" src="image/travis.jpg" alt="Portraid_Measurement, Evaluation, Philanthropy Projects and Fundraising Specialist">
            <h3>Measurement, Evaluation, Philanthropy Projects and Fundraising Specialist</h3>
            <p class="ptravis">Travis Chamberlain</p>
        </div>
       
        <div class="colaborador">
            <img class="vikram" src="image/Vikram.jpg" alt="Portraid Vikram Kannegundla, Technical Operations Specialist for Environmental Projects">
            <h3>Technical Operations Specialist for Environmental Projects</h3>
            <p class="pvikram">Vikram Kannegundla</p>
        </div>

        <div class="colaborador">
            <img class="robert" src="image/Robert.jpg" alt="Portraid Vikram Kannegundla, Project Coordinator Assistant in charge of Administrative Management">
            <h3>Project Coordinator Assistant in charge of Administrative Management</h3>
